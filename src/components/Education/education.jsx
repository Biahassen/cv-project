...
const Education = () => (
  <div className="app__newsletter">
    ...
    <p className="p__opensans">Elementary school</p>
      <input type="text" placeholder="Andelus 2002-2006" />
      <p className="p__opensans">Primary school</p>
      <input type="text" placeholder="Hilltops 2007-2012" />
      <p className="p__opensans">Highschool</p>
      <input type="text" placeholder="Spring of knowledge 2013-2018" />
      <p className="p__opensans">Higher Education</p>
      <input type="text" placeholder="AASTU 2018-2022" />
    </div>
  </div>
);
